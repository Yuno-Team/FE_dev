        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Container(
              ...
              padding: currentIndex == 2 ? EdgeInsets.symmetric(horizontal: 24, vertical: 4) : null,
              child: Icon(
                Icons.calendar_today_outlined,
                size: 24,
                color: currentIndex == 2 ? Color(0xFFBDC4D0).withOpacity(0.7) : Color(0xFFBDC4D0).withOpacity(0.7),
              ),
            ),
            label: '일정',
          ),
